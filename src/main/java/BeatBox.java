...
public class BeatBox {
    ...
    public void buildGUI() {
        theFrame = new JFrame("Beat-Box Machine");
        ...
        serializelt.addActionListener(new MyReadListener());
    ...
    public class MySendListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                FileOutputStream fileStream = new FileOutputStream(new File("Checkbox"));
    ...
    public class MyReadListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                FileInputStream fileIn = new FileInputStream(new File("Checkbox"));
